...
app.layout = html.Div(children=[html.H1('US Domestic Airline Flights Performance',
                            ...
                            #Review 2: creating dropdown menu
                            #create first outer division
                               html.Div([
                                   #Add an division
                                   html.Div([
                               ...
                               #second outer division for year dropdown
                                html.Div([
                                   html.Div([
                                       # Create an division for adding dropdown helper text for choosing year
                                       html.Div([html.H2('Choose Year:', style={'margin-right': '2em'})]),
                                       
                                       #second dropdown meny for year
                                       dcc.Dropdown(
                                           id = 'input-year',
                                ...
                                #third outer division for graphs 
                                #REVIEW3: Observe how we add an empty division and providing an id that will be updated during callback.
                                html.Div([], id='plot1'),
                                
                                #fourth division with two inner divs for plot 2 and 3
                                html.Div([
                                        html.Div([], id='plot2'),
                                        html.Div([], id='plot3')
                                    ], style={'display':'flex'}),
                                
                                #fifth division with 2 inner divs for plot 4 and 5
                                html.Div([
                                        html.Div([], id='plot4'),
                                        html.Div([], id='plot5')
                                    ], style={'display':'flex'})
...
def get_graph(chart, year, c1, c2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        ...
        bar_data, line_data, div_data, map_data, tree_data = data_for_choice1(df)
        ...
        tree_fig = px.treemap(tree_data,
                      ...
                      values='Flights',
                      #hover_data=['DestState', 'Reporting_Airline', 'Flights'],
                      color = 'Flights',
        ...
        # Compute required information for creating graph from the data
        avg_car, avg_weather, avg_NAS, avg_sec, avg_late = data_for_choice2(df)
